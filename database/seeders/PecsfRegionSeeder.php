...
class PecsfRegionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('pecsf_regions')->insert(['id' => 9,'name' => "Comox-Strathcona"]);
        ...
        DB::table('pecsf_regions')->insert(['id' => 21,'name' => "Powell River"]);
        DB::table('pecsf_regions')->insert(['id' => 22,'name' => "Haida Gwaii"]);
        ...
        DB::table('pecsf_regions')->insert(['id' => 27,'name' => "Vancouver"]);
        DB::table('pecsf_regions')->insert(['id' => 28,'name' => "Victoria"]);
